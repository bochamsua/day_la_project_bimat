 ...
 */
/**
 * Safety Data collection resource model
 *
 * @category    BS
 * @package     BS_Safety
 * @author Bui Phong
 */
class BS_Safety_Model_Resource_Safety_Collection extends Mage_Core_Model_Resource_Db_Collection_Abstract
{
