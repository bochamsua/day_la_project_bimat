<?php
class BS_Sur_Block_Adminhtml_Sur_Edit_Tab_Drr extends Mage_Adminhtml_Block_Widget_Grid
{
    /**
     * constructor
     *
        ...
        $this->setChild('add_drr_button',
            $this->getLayout()->createBlock('adminhtml/widget_button')
                ->setData(array(
                    ...
                    'onclick'   => 'window.open(\''.$this->getUrl('*/drr_drr/new', array('_current'=>false, 'ref_type'=>'sur', 'task_id'=>$this->getSur()->getTaskId(), 'ref_id'=>$this->getSur()->getId(),'popup'=>true)).'\',\'\',\'width=1000,height=700,resizable=1,scrollbars=1\')'
                ))
        );
