 ...
 */
/**
 * Surveillance collection resource model
 *
 * @category    BS
 * @package     BS_Sur
 * @author Bui Phong
 */
class BS_Sur_Model_Resource_Sur_Collection extends Mage_Core_Model_Resource_Db_Collection_Abstract
{
