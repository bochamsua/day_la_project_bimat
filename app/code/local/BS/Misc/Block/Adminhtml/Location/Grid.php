 ...
 * @author Bui Phong
 */
class BS_Misc_Block_Adminhtml_Location_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    /**
     * constructor
     *
     ...
     *
     * @access protected
     * @return BS_Misc_Block_Adminhtml_Location_Grid
     * @author Bui Phong
     */
    protected function _prepareCollection()
    {
        $collection = Mage::getModel('bs_misc/location')
            ->getCollection();
