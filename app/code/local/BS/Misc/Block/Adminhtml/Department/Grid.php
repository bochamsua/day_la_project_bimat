 ...
 */
/**
 * Department admin grid block
 *
 * @category    BS
 * @package     BS_Misc
 * @author Bui Phong
 */
class BS_Misc_Block_Adminhtml_Department_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    /**
     * constructor
     *
     ...
     *
     * @access protected
     * @return BS_Misc_Block_Adminhtml_Department_Grid
     * @author Bui Phong
     */
    protected function _prepareCollection()
    {
        $collection = Mage::getModel('bs_misc/department')
            ->getCollection();
...
//        );
     ...
     *
     * @access public
     * @param BS_Misc_Model_Department
     * @return string
     * @author Bui Phong
     */
