 ...
 */
/**
 * Import collection resource model
 *
 * @category    BS
 * @package     BS_Imex
 * @author Bui Phong
 */
class BS_Imex_Model_Resource_Im_Collection extends Mage_Core_Model_Resource_Db_Collection_Abstract
{
