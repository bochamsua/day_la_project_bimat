 ...
 */
class BS_Imex_Model_Im_Adapter_Csv extends BS_Imex_Model_Im_Adapter_Abstract
{
    /**
     * Field delimiter.
     *
    ...
    public function seek($position)
    {
        if ($position != $this->_currentKey) {
            ...
            throw new OutOfBoundsException(Mage::helper('bs_imex')->__('Invalid seek position'));
        }
    }
}
