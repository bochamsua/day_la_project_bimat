 ...
 */
/**
 * AC Sign-off collection resource model
 *
 * @category    BS
 * @package     BS_Signoff
 * @author Bui Phong
 */
class BS_Signoff_Model_Resource_Signoff_Collection extends Mage_Core_Model_Resource_Db_Collection_Abstract
{
