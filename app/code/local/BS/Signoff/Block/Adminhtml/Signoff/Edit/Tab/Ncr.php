<?php
class BS_Signoff_Block_Adminhtml_Signoff_Edit_Tab_Ncr extends Mage_Adminhtml_Block_Widget_Grid
{
    /**
     * constructor
     *
        ...
        $this->setChild('add_ncr_button',
            $this->getLayout()->createBlock('adminhtml/widget_button')
                ->setData(array(
                    ...
                    'onclick'   => 'window.open(\''.$this->getUrl('*/ncr_ncr/new', array('_current'=>false, 'ref_type'=>'signoff', 'task_id'=>$this->getSignoff()->getTaskId(), 'ref_id'=>$this->getSignoff()->getId(),'popup'=>true)).'\',\'\',\'width=1000,height=700,resizable=1,scrollbars=1\')'
                ))
        );
    ...
    public function getMainButtonsHtml()
    {
        ...
        if($this->getSignoff()->getId()){
            ...
            $html .= 'Please save Signoff first';
        }
