        ...
        $this->setChild('add_ncr_button',
            $this->getLayout()->createBlock('adminhtml/widget_button')
                ->setData([
                    ...
                    'onclick'   => 'window.open(\''.$this->getUrl('*/ncr_ncr/new', ['_current'=>false, 'ref_type'=>'signoff', 'task_id'=>$this->getSignoff()->getTaskId(), 'ref_id'=>$this->getSignoff()->getId(),'popup'=>true]).'\',\'\',\'width=1000,height=700,resizable=1,scrollbars=1\')'
                ])
        );
