        ...
        $this->setChild('add_ir_button',
            $this->getLayout()->createBlock('adminhtml/widget_button')
                ->setData([
                    ...
                    'onclick'   => 'window.open(\''.$this->getUrl('*/ir_ir/new', ['_current'=>false, 'ref_type'=>'drr', 'task_id'=>$this->getDrr()->getTaskId(), 'ref_id'=>$this->getDrr()->getId(),'popup'=>true]).'\',\'\',\'width=1000,height=700,resizable=1,scrollbars=1\')'
                ])
        );
