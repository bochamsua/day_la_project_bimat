        ...
        $this->setChild('add_ncr_button',
            $this->getLayout()->createBlock('adminhtml/widget_button')
                ->setData([
                    ...
                    'onclick'   => 'window.open(\''.$this->getUrl('*/ncr_ncr/new', ['_current'=>false, 'ref_type'=>'drr', 'task_id'=>$this->getDrr()->getTaskId(), 'ref_id'=>$this->getDrr()->getId(),'popup'=>true]).'\',\'\',\'width=1000,height=700,resizable=1,scrollbars=1\')'
                ])
        );
