<?php
class BS_Drr_Block_Adminhtml_Drr_Edit_Tab_Ncr extends Mage_Adminhtml_Block_Widget_Grid
{
    /**
     * constructor
     *
        ...
        $this->setChild('add_ncr_button',
            $this->getLayout()->createBlock('adminhtml/widget_button')
                ->setData(array(
                    ...
                    'onclick'   => 'window.open(\''.$this->getUrl('*/ncr_ncr/new', array('_current'=>false, 'ref_type'=>'drr', 'task_id'=>$this->getDrr()->getTaskId(), 'ref_id'=>$this->getDrr()->getId(),'popup'=>true)).'\',\'\',\'width=1000,height=700,resizable=1,scrollbars=1\')'
                ))
        );
    ...
    protected function _prepareCollection()
    {
        $collection = Mage::getModel('bs_ncr/ncr')
            ...
            ->addFieldToFilter('ref_type', 'drr')
            ->addFieldToFilter('ref_id', $this->getDrr()->getId())
        ;
