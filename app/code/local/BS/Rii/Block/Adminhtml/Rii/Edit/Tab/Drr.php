<?php
class BS_Rii_Block_Adminhtml_Rii_Edit_Tab_Drr extends Mage_Adminhtml_Block_Widget_Grid
{
    /**
     * constructor
     *
        ...
        $this->setChild('add_drr_button',
            $this->getLayout()->createBlock('adminhtml/widget_button')
                ->setData(array(
                    ...
                    'onclick'   => 'window.open(\''.$this->getUrl('*/drr_drr/new', array('_current'=>false, 'ref_type'=>'rii', 'task_id'=>$this->getRii()->getTaskId(), 'ref_id'=>$this->getRii()->getId(),'popup'=>true)).'\',\'\',\'width=1000,height=700,resizable=1,scrollbars=1\')'
                ))
        );
    ...
    protected function _prepareCollection()
    {
        $collection = Mage::getModel('bs_drr/drr')
            ...
            ->addFieldToFilter('ref_type', 'rii')
            ->addFieldToFilter('ref_id', $this->getRii()->getId())
        ;
