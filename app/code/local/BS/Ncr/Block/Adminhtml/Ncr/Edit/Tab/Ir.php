<?php
class BS_Ncr_Block_Adminhtml_Ncr_Edit_Tab_Ir extends Mage_Adminhtml_Block_Widget_Grid
{
    /**
     * constructor
     *
        ...
        $this->setChild('add_ir_button',
            $this->getLayout()->createBlock('adminhtml/widget_button')
                ->setData(array(
                    ...
                    'onclick'   => 'window.open(\''.$this->getUrl('*/ir_ir/new', array('_current'=>false, 'ref_type'=>'ncr', 'task_id'=>$this->getNcr()->getTaskId(), 'ref_id'=>$this->getNcr()->getId(),'popup'=>true)).'\',\'\',\'width=1000,height=700,resizable=1,scrollbars=1\')'
                ))
        );
