<?php
class BS_Ncr_Block_Adminhtml_Ncr_Edit_Tab_Coa extends Mage_Adminhtml_Block_Widget_Grid
{
    /**
     * constructor
     *
        ...
        $this->setChild('add_coa_button',
            $this->getLayout()->createBlock('adminhtml/widget_button')
                ->setData([
                    ...
                    'onclick'   => 'window.open(\''.$this->getUrl('*/coa_coa/new', ['_current'=>false, 'ref_type'=>'ncr', 'ref_id'=>$this->getNcr()->getId(),'popup'=>true]).'\',\'\',\'width=1000,height=700,resizable=1,scrollbars=1\')'
                ])
        );
