 ...
 */
/**
 * CMR Report collection resource model
 *
 * @category    BS
 * @package     BS_CmrReport
 * @author Bui Phong
 */
class BS_CmrReport_Model_Resource_Cmrreport_Collection extends Mage_Core_Model_Resource_Db_Collection_Abstract
{
