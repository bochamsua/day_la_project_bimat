<?php
class BS_Cofa_Block_Adminhtml_Cofa_Edit_Tab_Drr extends Mage_Adminhtml_Block_Widget_Grid
{
    /**
     * constructor
     *
        ...
        $this->setChild('add_drr_button',
            $this->getLayout()->createBlock('adminhtml/widget_button')
                ->setData(array(
                    ...
                    'onclick'   => 'window.open(\''.$this->getUrl('*/drr_drr/new', array('_current'=>false, 'ref_type'=>'cofa', 'task_id'=>$this->getCofa()->getTaskId(), 'ref_id'=>$this->getCofa()->getId(),'popup'=>true)).'\',\'\',\'width=1000,height=700,resizable=1,scrollbars=1\')'
                ))
        );
