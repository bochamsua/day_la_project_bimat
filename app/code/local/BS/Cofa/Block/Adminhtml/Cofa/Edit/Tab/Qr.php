<?php
class BS_Cofa_Block_Adminhtml_Cofa_Edit_Tab_Qr extends Mage_Adminhtml_Block_Widget_Grid
{
    /**
     * constructor
     *
        ...
        $this->setChild('add_qr_button',
            $this->getLayout()->createBlock('adminhtml/widget_button')
                ->setData(array(
                    ...
                    'onclick'   => 'window.open(\''.$this->getUrl('*/qr_qr/new', array('_current'=>false, 'taskgroup_id'=>4, 'type'=>'base','task_id'=>$this->getCofa()->getTaskId(), 'ref_id'=>$this->getCofa()->getId(),'popup'=>true)).'\',\'\',\'width=1000,height=700,resizable=1,scrollbars=1\')'
                ))
        );
    ...
    protected function _prepareCollection()
    {
        $collection = Mage::getModel('bs_qr/qr')
            ->getCollection()
            //->addFieldToFilter('taskgroup_id', 4)
