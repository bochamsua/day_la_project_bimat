        ...
        $this->setChild('add_qr_button',
            $this->getLayout()->createBlock('adminhtml/widget_button')
                ->setData([
                    ...
                    'onclick'   => 'window.open(\''.$this->getUrl('*/qr_qr/new', ['_current'=>false, 'taskgroup_id'=>4, 'type'=>'base','task_id'=>$this->getCofa()->getTaskId(), 'ref_id'=>$this->getCofa()->getId(),'popup'=>true]).'\',\'\',\'width=1000,height=700,resizable=1,scrollbars=1\')'
                ])
        );
