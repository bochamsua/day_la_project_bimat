        ...
        $this->setChild('add_drr_button',
            $this->getLayout()->createBlock('adminhtml/widget_button')
                ->setData([
                    ...
                    'onclick'   => 'window.open(\''.$this->getUrl('*/drr_drr/new', ['_current'=>false, 'ref_type'=>'cmr', 'task_id'=>32, 'ref_id'=>$this->getCmr()->getId(),'popup'=>true]).'\',\'\',\'width=1000,height=700,resizable=1,scrollbars=1\')'
                ])
        );
