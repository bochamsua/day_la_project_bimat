<?php
class BS_Car_Block_Adminhtml_Car_Edit_Tab_Coa extends Mage_Adminhtml_Block_Widget_Grid
{
    /**
     * constructor
     *
        ...
        $this->setChild('add_coa_button',
            $this->getLayout()->createBlock('adminhtml/widget_button')
                ->setData([
                    ...
                    'onclick'   => 'window.open(\''.$this->getUrl('*/coa_coa/new', ['_current'=>false, 'ref_type'=>'car', 'ref_id'=>$this->getCar()->getId(),'popup'=>true]).'\',\'\',\'width=1000,height=700,resizable=1,scrollbars=1\')'
                ])
        );
    ...
    protected function _prepareCollection()
    {
        $collection = Mage::getModel('bs_coa/coa')
            ...
            ->addFieldToFilter('ref_type', 'car')
            ->addFieldToFilter('ref_id', $this->getCar()->getId())
        ;
