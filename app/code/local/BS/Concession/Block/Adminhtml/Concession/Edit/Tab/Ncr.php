        ...
        $this->setChild('add_ncr_button',
            $this->getLayout()->createBlock('adminhtml/widget_button')
                ->setData([
                    ...
                    'onclick'   => 'window.open(\''.$this->getUrl('*/ncr_ncr/new', ['_current'=>false, 'ref_type'=>'concession', 'task_id'=>$this->getConcession()->getTaskId(), 'ref_id'=>$this->getConcession()->getId(),'popup'=>true]).'\',\'\',\'width=1000,height=700,resizable=1,scrollbars=1\')'
                ])
        );
