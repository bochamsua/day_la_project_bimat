<?php
class BS_Concession_Block_Adminhtml_Concession_Edit_Tab_Ncr extends Mage_Adminhtml_Block_Widget_Grid
{
    /**
     * constructor
     *
        ...
        $this->setChild('add_ncr_button',
            $this->getLayout()->createBlock('adminhtml/widget_button')
                ->setData(array(
                    ...
                    'onclick'   => 'window.open(\''.$this->getUrl('*/ncr_ncr/new', array('_current'=>false, 'ref_type'=>'concession', 'task_id'=>$this->getConcession()->getTaskId(), 'ref_id'=>$this->getConcession()->getId(),'popup'=>true)).'\',\'\',\'width=1000,height=700,resizable=1,scrollbars=1\')'
                ))
        );
