 ...
 */
/**
 * Concession Data collection resource model
 *
 * @category    BS
 * @package     BS_Concession
 * @author Bui Phong
 */
class BS_Concession_Model_Resource_Concession_Collection extends Mage_Core_Model_Resource_Db_Collection_Abstract
{
