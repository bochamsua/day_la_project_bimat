 ...
 */
/**
 * Routine Report collection resource model
 *
 * @category    BS
 * @package     BS_Routine
 * @author Bui Phong
 */
class BS_Routine_Model_Resource_Routine_Collection extends Mage_Core_Model_Resource_Db_Collection_Abstract
{
