<?php
class BS_Other_Block_Adminhtml_Other_Edit_Tab_Ir extends Mage_Adminhtml_Block_Widget_Grid
{
    /**
     * constructor
     *
        ...
        $this->setChild('add_ir_button',
            $this->getLayout()->createBlock('adminhtml/widget_button')
                ->setData(array(
                    ...
                    'onclick'   => 'window.open(\''.$this->getUrl('*/ir_ir/new', array('_current'=>false, 'ref_type'=>'other', 'task_id'=>$this->getOther()->getTaskId(), 'ref_id'=>$this->getOther()->getId(),'popup'=>true)).'\',\'\',\'width=1000,height=700,resizable=1,scrollbars=1\')'
                ))
        );
