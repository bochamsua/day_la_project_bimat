 ...
 */
/**
 * Other Work collection resource model
 *
 * @category    BS
 * @package     BS_Other
 * @author Bui Phong
 */
class BS_Other_Model_Resource_Other_Collection extends Mage_Core_Model_Resource_Db_Collection_Abstract
{
