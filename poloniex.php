...
$api_key = '0G9QPOAB-QDGXNJEG-C32D6IT5-HHHZG7U7';
$api_secret = 'b95b8de34623d1fd84dc1f0e2de54b8a1fae756e9dff3eb07220025425c9168e3c6ee4d8bdfb1e8b861e34afd3a9e70d7809354729e7c4192efeb829eeb71c58';


//$po = new Poloniex($api_key, $api_secret);
//

$ticker = get_ssl_page('https://poloniex.com/public?command=returnTicker');
$json = json_decode($ticker, true);
...
class Poloniex {
    ...
    public function get_ssl_page($base){
        $curl = curl_init();
